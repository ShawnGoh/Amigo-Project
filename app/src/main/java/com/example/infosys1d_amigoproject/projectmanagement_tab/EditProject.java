...
//        saveproject = findViewById(R.id.editPbutton_create_project);
...
//                textInputLayout.setPlaceholderText(project.getProjectitle());
//                textInputLayoutdescrip.setPlaceholderText(project.getProjectdescription());
